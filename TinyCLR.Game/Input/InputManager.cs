...
namespace TinyCLR.Game.Input
{
  ...
  public class InputManager
  {
    ...
    private readonly IInputProvider[] _providers = new IInputProvider[MaxProviders];
    ...
    internal void Update(float elapsedTime)
    {
      ...
      for (int i = 0; i < _count; ++i)
      {
        ...
        xSum += provider.X;
        ySum += provider.Y;
        Button1 = Button1 || provider.Button1;
        Button2 = Button2 || provider.Button2;
        Button3 = Button3 || provider.Button3;
        Button4 = Button4 || provider.Button4;
      }
