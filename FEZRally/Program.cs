...
namespace FEZRally
{
    class Program
    {
        private static RallyXGame _rallyxGame = null;
        ...
        static void Main()
        {
            ...
            _rallyxGame = new RallyXGame(surface);
            _rallyxGame.InputManager.AddInputProvider(new FEZBitInputProvider());
            _rallyxGame.Initialize();
